...
CONTACT_EMAIL = 'koreapuzzlehunt@gmail.com'
...
MESSAGING_SENDER_EMAIL = 'koreapuzzlehunt@gmail.com'
...
REQUESTING_HINT_END_TIME = settings.REQUESTING_HINT_END_TIME
